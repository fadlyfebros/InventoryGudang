 ...
 * @author fadly
 */
public class ReportSupplier extends javax.swing.JPanel {
    ...
    private void loadData() {
        ...
        tblReportSupplier.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        tblReportSupplier = new javax.swing.JTable();
        ...
        tblReportSupplier.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblReportSupplier);

        jLabel3.setBackground(new java.awt.Color(51, 51, 255));
        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setText("Report Supplier");
    ...
    private void btnPencarianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPencarianActionPerformed
        ...
        try (Connection c = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            String query = "SELECT * FROM tb_suplier " +
                           "WHERE namaSuplier LIKE '%" + keyword + "%'"; // Ubah kolom dan kondisi sesuai kebutuhan pencarian
    ...
    private javax.swing.JTable tblReportSupplier;
